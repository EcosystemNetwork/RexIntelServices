...
const incidents: IntelPayload[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "",
      "**Editor's note — first-person disclosure.** This newsroom's principal investigator was among the affected miner cohort, carrying more than \\$30,000 of value across MXC token and M2 Pro hardware at the announcement of the Moonchain transition — value that was crystallised, by the xMXC conversion and the parallel collapse of the custodial mining surface, into a fraction of itself. The loss is disclosed here in the interest of transparency: it does not change the public-source corpus the analysis is built on, and it is not the basis of any of the structural claims above, but readers are entitled to know that the newsroom carrying this brief has personal skin in the cohort it is reporting on. The structural argument stands or falls on the public record; the disclosure exists so that record can be weighed honestly.",
    ].join("\n"),
    sources: [
