...
const fellowships: FellowshipPayload[] = [
  ...
  // === AI safety + alignment fellowships (added 2026-05-17) ===
  {
    ...
    description:
      "Top AI-safety research fellowship — 10 weeks in-person in Berkeley + London (extension phase), paired with senior mentors from Anthropic, OpenAI, DeepMind, Redwood, ARC. Seven tracks: Empirical, Theory, Strategy & Forecasting, Policy & Governance, Systems Security, Founding & Field-Building, Biosecurity. $12,500 stipend + $20,000 compute allowance, with housing, meals, travel, and J1 visa sponsorship covered. Three application stages: General Application (deadline Jun 7), Central Evaluations (late June), Stream Applications (Jun–late July), offers late July/early August. ~80% of alumni go on to work full-time in AI alignment/security; 190 research publications from alumni in the last 4 years.",
    stipend: "$12,500 stipend + $20,000 compute allowance + housing, meals, travel, J1 visa",
    stipendUsd: 12500,
    duration: "10–12 weeks (main phase Sep 28 – Dec 4, 2026; London extension after)",
    eligibility:
      "Empirical / theoretical AI safety researchers and field-builders. Open globally — diverse backgrounds welcomed (ML, math, CS, policy, economics, physics, cognitive science). Prior AI safety experience helpful but not required; strong motivation + technical aptitude required.",
    location: "Berkeley, CA + London, UK (in-person, open to applicants worldwide; J1 visa sponsored)",
    ...
    tags: ["mats", "ai-safety", "alignment", "berkeley", "london", "compute-allowance", "j1-visa"],
  },
  {
