...
const originals: IntelPayload[] = [
  {
    ...
    anonymous: true,
    bodyFormat: "markdown",
    dek: "Chainalysis puts the DPRK haul at $2.02B for 2025 — a single-year record, ~60% of the global theft total. Fewer incidents, larger heists, endpoint-first instead of contract-first.",
    heroImageUrl: "/intel-heroes/dprk-2b-2025.svg",
    heroAlt: "DPRK 2025 crypto take: $2.02 billion — single-year record.",
    heroCaption: "DPRK's 2025 take was a single-year record built on fewer, larger heists targeting humans rather than smart contracts.",
    heroCredit: "Rex Intel Services · Source: Chainalysis 2026 preview",
    body: [
  ...
  },
  {
    ...
    anonymous: true,
    bodyFormat: "markdown",
    dek: "Tornado Cash is legal again. DPRK didn't rush back — they're routing through a portfolio of mixers, THORChain, and SE-Asian off-ramps on a deliberate 45-day cycle.",
    heroImageUrl: "/intel-heroes/post-tornado-cash.svg",
    heroAlt: "45-day default DPRK laundering cycle, sub-$500k tranches.",
    heroCaption: "The 2025 incident set shows DPRK clusters slow-walking funds on a 45-day cycle to defeat speed-based monitoring.",
  ...
  },
  {
    ...
    anonymous: true,
    bodyFormat: "markdown",
    dek: "Three of 2024's largest incidents — Munchables, Radiant, DMM Bitcoin — share a kill chain that did not exist in 2022. Hire a developer, wait, drain.",
    heroImageUrl: "/intel-heroes/dprk-it-worker-kill-chain.svg",
    heroAlt: "$417 million stolen via placed-operator drains in 2024 alone.",
    heroCaption: "Placement → patient build → drain. The threat model now includes the engineer themselves.",
    heroCredit: "Rex Intel Services · Source: ZachXBT, Mandiant, US Treasury advisories",
    body: [
  ...
  },
  {
    ...
    anonymous: true,
    bodyFormat: "markdown",
    dek: "The two largest single-event exchange losses of 2024-2025 share a failure mode subtle enough that neither team's pre-incident threat model accounted for it. Cryptography wasn't broken — the interface was.",
    heroImageUrl: "/intel-heroes/sign-blind-multisigs.svg",
    heroAlt: "$1.74 billion in UI-layer drains across Bybit and WazirX in 2024-2025.",
    heroCaption: "Multiple human signers approved transactions whose displayed semantics had nothing to do with their on-chain effect. The load-bearing 2026 question.",
    heroCredit: "Rex Intel Services · Source: NCC Group, Crystal Intelligence, TRM Labs",
    body: [
  ...
  },
  {
    ...
    anonymous: true,
    bodyFormat: "markdown",
    dek: "Pooling the bridge-loss incident set yields five distinct root causes — and most production bridges are exposed to at least two of them.",
    heroImageUrl: "/intel-heroes/bridges-five-failure-modes.svg",
    heroAlt: "Five architectural failure modes that account for every major bridge loss to date.",
    heroCaption: "Validator capture, sig-verification bypass, message-proof construction, off-chain key custody, upgrade-path abuse. Ranked.",
    heroCredit: "Rex Intel Services · Source: Elliptic, Chainalysis, Immunefi",
    body: [
  ...
  },
  {
    ...
    anonymous: true,
    bodyFormat: "markdown",
    dek: "Between its 2019 founding and the OFAC designation, Garantex processed $100B — and Treasury estimated 82% of that volume was tied to sanctioned entities. The canonical sanctions-evasion exchange case.",
    heroImageUrl: "/intel-heroes/garantex.svg",
    heroAlt: "$100 billion lifetime laundered volume through Garantex.",
    heroCaption: "Tron USDT is the dominant 2024-2025 illicit-flow rail. If you treat Tron as low-priority, Lazarus is exploiting that blind spot.",
    heroCredit: "Rex Intel Services · Source: OFAC, Chainalysis, TRM Labs",
    body: [
  ...
  },
  {
    ...
    anonymous: true,
    bodyFormat: "markdown",
    dek: "A wallet sitting quiet for 30 days after a major incident isn't safe — it's pre-cycle. What 'fresh' versus 'cold' means in 2026.",
    heroImageUrl: "/intel-heroes/dprk-45-day-cycle.svg",
    heroAlt: "60-to-90 day post-incident scrutiny window for KYC programs.",
    heroCaption: "Three pressures compound to slow DPRK laundering: mixer regulatory churn, heuristic adversarialism, off-ramp capacity limits.",
    heroCredit: "Rex Intel Services · Source: Chainalysis, TRM Labs",
    body: [
